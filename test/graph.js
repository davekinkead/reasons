...
//     // nodes should be instances of Node
//     // edges should be instances of Edges
...
//       graph.parents('d')[0].id.should.be.equal(map.c.id)
//     })
//   })  
...
//       graph.children(map.b)[0].id.should.be.equal(map.c.id)
//     })
